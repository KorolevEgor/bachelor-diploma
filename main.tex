...
\DeclareCaptionLabelFormat{gostfigure}{� исунок #2}
...
%\usepackage[backend=biber,bibencoding=utf8,sorting=nty,maxcitenames=2,style=numeric-comp]{}
%\addbibresource{list_of_bibliography.bib}
\usepackage[backend=biber,style=numeric,sorting=none]{biblatex}
\usepackage{csquotes}
\addbibresource{bibliographic_list.bib} %% подключение библиографической базы из файла sample.bib
...
\chapter{Пуассоновская регрессия}

\chapter{Геометрическая регрессия}
