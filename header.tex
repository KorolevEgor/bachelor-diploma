...
\captionsetup[figure]{labelformat=gostfigure, justification=centering, singlelinecheck=false}
\captionsetup[table]{labelformat=gosttable, justification=raggedright, singlelinecheck=false}
...
%\titleformat{\chapter}[display]
%    {\filcenter}
%    {\MakeUppercase{\text{ГЛАВА}} \thechapter}
%    {8pt}
%    {\bfseries}{}
